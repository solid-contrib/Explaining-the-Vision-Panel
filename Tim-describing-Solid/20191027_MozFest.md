...
it's also access control standards so it's not just a HTTP we have to add things to it it's also we've got things lik standards for doing contact so that every path can access your contact
information and things like that so it's a it's a standard 

# 20191027_MozFest_08:15
we've got company what society from my point of view is the first time in a gazillion years like since the 80s oh no working with a start-up and yeah it's called enrapt intercom an interrupt has also there what's been nice is been able to watch this for several years we had nice research funding for who is MIT now it's appropriate now to just be a put moreenergy into it who you never got we have commercial funding from Gosling ventures my others and to make this thing having so we can put we can but people on getting my making documentation we still have we have a finite number of people so in fact what interruptus done also is benefited enough just in the few days that it's been running we've had this tremendous surge of people arriving online people arriving here as well when we're in the science we have as people in science fair I'm sorry if I heard from somebody today who couldn't get to it because it was because he couldn't because there are too many people but but you can go there we'll have whatever stairs you can get stickers there but uh there's still sort of what's amazing about it has been the the amount of enthusiasm out there I suppose people some people say your documentation is non-existent I've blogged this is this is I tried it I put all the buttons I figured out how it worked and this is my blog and we had a couple of people doing that which is totally wonderful other people and so now we have got we got a gitter channel for discussing the documentation problems and actually and creating groups of people to create documentation we've got people working on different aspects of the software of the server the

# 20191027_MozFest_10:05
server is something which basically is pretty that's most developed but so you can get the document you can so you can install it it's a new NPM install node solid server and it should run go onto gitter channel if you if you need helpgetting your running. 

# 20191027_MozFest_10:20
the apps are really early days because the idea is to get aserver you know the community needs to create the server once it's created a server that everybody can make that we've got some apps I've got some appsI've got I run all of my life on apps most of my life actually runs easy solid apps but but the idea is that there will be thousands of flowers blooming millions of flowers blooming when the apps but their work that goes into the backend into the solid servers will have
them written in different languages if you're interested go programmers see me afterwards and so for example but the 

the way the architecture works is work on the server is finite we technically we have to maintain air what how to makenew versions and stuff and all the energy goes into the app because the apps run in the browser or they run on
the person computer they run under and 

# 20191027_MozFest_11:15
The spirit of Solid is that when you are writing your solid app you are not trying to trick them. We're going to have a concept of a beneficent app and maybe a brand. So maybe beneficentapps.org. So if you put the beneficent apps brand on it you have sworn as a developer that your  software will act on behalf of the user. You will not try to trick them into buying something in the middle of what they're doing. You will try to help them concentrate on what they're doing, you will help them collaborate, you will help them communicate. So that is a spirit it's a new spirit.  

# 20191027_MozFest_11:56
People say: 'where are you going to get, who's going to fund it if this is going to be no advertising? well guess what I think that we've got also a lot of people who are, after the fake news wave, are saying: 'you know what I realized I have to pay I want, urgeently need to pay for news, for somebody to figure things out and tell me the things that I can trust. I realized actually I am prepared to pay, like you give it to me give for free for data yet but I I might pay just pay for this data storage because I respect that this data storage that I am using the solid pod doesn't abuse me and I'll pay for that
to keep the whole system going and I will pay I'll donate, I will use open source apps but I will donate to them to keep
the developers food on the table because I really respect these apps cuz these apps that they called user agents. 

You know Mozilla the the noble Firefox is a is a user agent technically it's called user agent that was the term for the
time and the idea of that was it represents the user that's kind of term not that's coming back with a solid apps are use agents they work on behalf of users it's a new revolution it's different but very exciting. Do join in.Thank you for your attention, and we have time for questions. 

# 20191027_MozFest_13:58

Just recently, a few weeks ago, did you come across the data data transfer project? So the data transfer project is Google and Facebook and Microsoft and Twitter and their partenrs announced by the way, we will give you the technical ability to move your data from one silo and more it into another silo. So that means you can download it, so you can go
to Google already done this you can go
14:31
